...
# Resolve LLVM metadata from the Zig lock when needed.
...
# Resolve repository refs and validate IWYU compatibility.
...
# Checkout sources and persist immutable lock metadata.
