...
initial_cc="${INITIAL_CC:-${INITIAL_TOOLCHAIN_BIN:-/usr/bin}/clang}"
initial_cxx="${INITIAL_CXX:-${INITIAL_TOOLCHAIN_BIN:-/usr/bin}/clang++}"
initial_ar="${INITIAL_AR:-${INITIAL_TOOLCHAIN_BIN:-/usr/bin}/llvm-ar}"
initial_ranlib="${INITIAL_RANLIB:-${INITIAL_TOOLCHAIN_BIN:-/usr/bin}/llvm-ranlib}"
initial_ld="${INITIAL_LD:-${INITIAL_TOOLCHAIN_BIN:-/usr/bin}/ld.lld}"
